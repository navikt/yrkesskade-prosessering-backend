...
@EnableJpaRepositories(basePackages = ["no.nav.yrkesskade", "no.nav.familie"])
@EntityScan(basePackages = ["no.nav.yrkesskade", "no.nav.familie"])
@ComponentScan(basePackages = ["no.nav.yrkesskade", "no.nav.familie"])
